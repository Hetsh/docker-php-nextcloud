...
RUN apk update && \
    ...
    php82-posix=8.2.20-r0 \
    php82-session=8.2.20-r0 \
    php82-simplexml=8.2.20-r0 \
    php82-sodium=8.2.20-r0 \
    php82-sqlite3=8.2.20-r0 \
    php82-sysvsem=8.2.20-r0 \
    php82-xml=8.2.20-r0 \
    php82-xmlreader=8.2.20-r0 \
    php82-xmlwriter=8.2.20-r0 \
    php82-zip=8.2.20-r0
