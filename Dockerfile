...
RUN apk update && \
    apk add --no-cache \
    imagemagick-svg=7.1.1.36-r0 \
    php82-bcmath=8.2.22-r0 \
    php82-bz2=8.2.22-r0 \
    php82-ctype=8.2.22-r0 \
    php82-curl=8.2.22-r0 \
    php82-dom=8.2.22-r0 \
    php82-exif=8.2.22-r0 \
    php82-fileinfo=8.2.22-r0 \
    php82-gd=8.2.22-r0 \
    php82-gmp=8.2.22-r0 \
    php82-iconv=8.2.22-r0 \
    php82-imap=8.2.22-r0 \
    php82-intl=8.2.22-r0 \
    php82-ldap=8.2.22-r0 \
    php82-mbstring=8.2.22-r0 \
    php82-opcache=8.2.22-r0 \
    php82-openssl=8.2.22-r0 \
    php82-pcntl=8.2.22-r0 \
    php82-pdo_mysql=8.2.22-r0 \
    php82-pdo_sqlite=8.2.22-r0 \
    php82-pecl-imagick=3.7.0-r6 \
    php82-pecl-mcrypt=1.0.7-r0 \
    php82-pecl-smbclient=1.1.1-r0 \
    php82-phar=8.2.22-r0 \
    php82-posix=8.2.22-r0 \
    php82-session=8.2.22-r0 \
    php82-simplexml=8.2.22-r0 \
    php82-sodium=8.2.22-r0 \
    php82-sqlite3=8.2.22-r0 \
    php82-sysvsem=8.2.22-r0 \
    php82-xml=8.2.22-r0 \
    php82-xmlreader=8.2.22-r0 \
    php82-xmlwriter=8.2.22-r0 \
    php82-zip=8.2.22-r0
