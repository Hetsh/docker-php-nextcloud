...
RUN echo "https://dl-cdn.alpinelinux.org/alpine/edge/testing/" >> /etc/apk/repositories && \
	...
	apk add --no-cache \
        php81-bz2=8.1.24-r0 \
        php81-bcmath=8.1.24-r0 \
        php81-curl=8.1.24-r0 \
        php81-ctype=8.1.24-r0 \
        php81-dom=8.1.24-r0 \
        php81-exif=8.1.24-r0 \
        php81-fileinfo=8.1.24-r0 \
        php81-gd=8.1.24-r0 \
        php81-gmp=8.1.24-r0 \
        php81-iconv=8.1.24-r0 \
        php81-imap=8.1.24-r0 \
        php81-intl=8.1.24-r0 \
        php81-ldap=8.1.24-r0 \
        php81-mbstring=8.1.24-r0 \
        php81-opcache=8.1.24-r0 \
        php81-openssl=8.1.24-r0 \
        php81-pcntl=8.1.24-r0 \
        php81-pdo_sqlite=8.1.24-r0 \
        php81-pdo_mysql=8.1.24-r0 \
        php81-posix=8.1.24-r0 \
