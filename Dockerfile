...
ARG LAST_UPGRADE="2026-08-30T11:11:30+02:00"
RUN echo "https://dl-cdn.alpinelinux.org/alpine/edge/testing/" >> /etc/apk/repositories && \
	...
	apk add --no-cache \
		...
		php85-pcntl=8.5.10-r0 \
		php85-pdo_mysql=8.5.10-r0 \
		...
		php85-posix=8.5.10-r0 \
		php85-session=8.5.10-r0 \
		php85-simplexml=8.5.10-r0 \
		php85-sodium=8.5.10-r0 \
		php85-sqlite3=8.5.10-r0 \
		php85-sysvsem=8.5.10-r0 \
		php85-xml=8.5.10-r0 \
		php85-xmlreader=8.5.10-r0 \
		php85-xmlwriter=8.5.10-r0 \
		php85-zip=8.5.10-r0
