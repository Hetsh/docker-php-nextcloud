...
RUN apk add --no-cache \
        ...
        php8-pcntl=8.0.22-r0 \
        php8-pdo_sqlite=8.0.22-r0 \
        php8-pdo_mysql=8.0.22-r0 \
        php8-posix=8.0.22-r0 \
        php8-session=8.0.22-r0 \
        php8-simplexml=8.0.22-r0 \
        php8-sqlite3=8.0.22-r0 \
        php8-xml=8.0.22-r0 \
        php8-xmlreader=8.0.22-r0 \
        php8-xmlwriter=8.0.22-r0 \
        php8-zip=8.0.22-r0 \
