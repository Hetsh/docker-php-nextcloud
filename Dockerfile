...
RUN apk update && \
    ...
    php83-bcmath=8.3.20-r0 \
    php83-bz2=8.3.20-r0 \
    php83-ctype=8.3.20-r0 \
    php83-curl=8.3.20-r0 \
    php83-dom=8.3.20-r0 \
    php83-exif=8.3.20-r0 \
    php83-fileinfo=8.3.20-r0 \
    php83-gd=8.3.20-r0 \
    php83-gmp=8.3.20-r0 \
    php83-iconv=8.3.20-r0 \
    php83-imap=8.3.20-r0 \
    php83-intl=8.3.20-r0 \
    php83-ldap=8.3.20-r0 \
    php83-mbstring=8.3.20-r0 \
    php83-opcache=8.3.20-r0 \
    php83-openssl=8.3.20-r0 \
    php83-pcntl=8.3.20-r0 \
    php83-pdo_mysql=8.3.20-r0 \
    php83-pdo_sqlite=8.3.20-r0 \
    php83-pecl-imagick=3.8.0-r0 \
    php83-pecl-mcrypt=1.0.7-r0 \
    php83-pecl-smbclient=1.2.0_pre-r0 \
    php83-phar=8.3.20-r0 \
    php83-posix=8.3.20-r0 \
    php83-session=8.3.20-r0 \
    php83-simplexml=8.3.20-r0 \
    php83-sodium=8.3.20-r0 \
    php83-sqlite3=8.3.20-r0 \
    php83-sysvsem=8.3.20-r0 \
    php83-xml=8.3.20-r0 \
    php83-xmlreader=8.3.20-r0 \
    php83-xmlwriter=8.3.20-r0 \
    php83-zip=8.3.20-r0
