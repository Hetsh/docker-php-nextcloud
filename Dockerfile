...
RUN apk add --no-cache \
        php8-bz2=8.0.10-r2 \
        php8-bcmath=8.0.10-r2 \
        php8-curl=8.0.10-r2 \
        php8-ctype=8.0.10-r2 \
        php8-dom=8.0.10-r2 \
        php8-exif=8.0.10-r2 \
        php8-fileinfo=8.0.10-r2 \
        php8-gd=8.0.10-r2 \
        php8-gmp=8.0.10-r2 \
        php8-iconv=8.0.10-r2 \
        php8-imap=8.0.10-r2 \
        php8-intl=8.0.10-r2 \
        php8-ldap=8.0.10-r2 \
        php8-mbstring=8.0.10-r2 \
        php8-opcache=8.0.10-r2 \
        php8-openssl=8.0.10-r2 \
        php8-pcntl=8.0.10-r2 \
        php8-pdo_sqlite=8.0.10-r2 \
        php8-pdo_mysql=8.0.10-r2 \
        php8-posix=8.0.10-r2 \
        php8-session=8.0.10-r2 \
        php8-simplexml=8.0.10-r2 \
        php8-sqlite3=8.0.10-r2 \
        php8-xml=8.0.10-r2 \
        php8-xmlreader=8.0.10-r2 \
        php8-xmlwriter=8.0.10-r2 \
        php8-zip=8.0.10-r2 \
