...
RUN echo "https://dl-cdn.alpinelinux.org/alpine/edge/testing/" >> /etc/apk/repositories && \
	...
	apk add --no-cache \
        ...
        php81-pcntl=8.1.18-r0 \
        php81-pdo_sqlite=8.1.18-r0 \
        php81-pdo_mysql=8.1.18-r0 \
        php81-posix=8.1.18-r0 \
        php81-session=8.1.18-r0 \
        php81-simplexml=8.1.18-r0 \
        php81-sqlite3=8.1.18-r0 \
        php81-xml=8.1.18-r0 \
        php81-xmlreader=8.1.18-r0 \
        php81-xmlwriter=8.1.18-r0 \
        php81-zip=8.1.18-r0 \
        php81-pecl-imagick=3.7.0-r1 \
