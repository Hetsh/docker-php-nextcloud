...
ARG LAST_UPGRADE="2026-01-24T12:22:56+01:00"
RUN echo "https://dl-cdn.alpinelinux.org/alpine/edge/testing/" >> /etc/apk/repositories && \
    ...
    apk add --no-cache \
        ...
        php84-posix=8.4.17-r0 \
        php84-session=8.4.17-r0 \
        php84-simplexml=8.4.17-r0 \
        php84-sodium=8.4.17-r0 \
        php84-sqlite3=8.4.17-r0 \
        php84-sysvsem=8.4.17-r0 \
        php84-xml=8.4.17-r0 \
        php84-xmlreader=8.4.17-r0 \
